    ...
    <Box className=" bg-black width-full hidden lg:flex flex-col lg:flex-row h-[600px] relative">
      ...
      >
        {allImages.map((item, index) => (
          ...
          >
            <Image width={1200} height={700} src={item} key={index} alt="pic"/>
          </SwiperSlide>
        ))}
      </Swiper>
    </Box>
  ...
  return (
    <Box sx={styles.imgContainer} className="block lg:hidden">
      ...
      >
        {allImages.map((item, index) => (
          <SwiperSlide key={index}>
            <img style={styles.phoneImage} src={item} alt="pic" key={index} />
          </SwiperSlide>
        ))}
      </Swiper>
      <Swiper
      ...
      >
        {allImages.map((item, index) => (
          <SwiperSlide key={index}>
            <Image width={1200} height={500} alt="pic" src={item} key={index} />
          </SwiperSlide>
        ))}
      </Swiper>
    </Box>
